...
if __name__ == "__main__":
    adicionar_livro(Livro(titulo="Dom Casmurro",
                    autor="Machado de Assis", ano_publicacao=1899))
    adicionar_livro(Livro(titulo="O Pequeno Príncipe",
                    autor="Antoine de Saint-Exupéry", ano_publicacao=1943))

    print("Livros de Machado de Assis:",
          buscar_livros_por_autor("Machado de Assis"))
    # Supondo que o ID do "Dom Casmurro" seja 1
