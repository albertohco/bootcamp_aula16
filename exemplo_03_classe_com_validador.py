...
# Exemplo de uso
venda_validada = VendaValidada(
    1, "Notebook Gamer", 5000.00, 2, date(2024, 3, 18), "cliente@example.com")
print(venda_validada)

try:
    venda_invalidada = VendaValidada(
        1, "Notebook Gamer", -5000.00, 2, date(2024, 3, 18), "cliente")
